...
if __name__ == "__main__":
  ...
  file_path = "/data01/dlu12/SMNDVI_Binaries"

  # Retrieve input for year to be mapped from the command line
  date = str(input("Enter date of data to be mapped (YYYYMMDD): "))
  file_name = f"SMNDVI_{date}.dat"
